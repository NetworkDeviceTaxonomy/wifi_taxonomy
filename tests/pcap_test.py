...
regression = [
  ...
  ('Moto X', './testdata/pcaps/Moto X 2nd gen 2.4GHz Broadcast Probe.pcap'),
  ('Moto X', './testdata/pcaps/Moto X 1st gen 2.4GHz GFRG210 An5.1 Broadcast Probe.pcap'),
  ('Moto X', './testdata/pcaps/Moto X 1st gen 2.4GHz Google Wifi An5.1 Broadcast Probe.pcap'),
  ('Moto X', './testdata/pcaps/Moto X 1st gen 2.4GHz OnHub An5.1 Broadcast Probe.pcap'),
